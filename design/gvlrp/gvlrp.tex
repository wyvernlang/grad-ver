...
\newcommand{\GWLP}{\widetilde{\tsf{WLP}}}
...
\newcommand{\tainted}{\tsf{tainted}}

\newcommand{\cthis}{\code{this}}
\newcommand{\cold}{\code{old}}

\newcommand{\Statement}{\tsc{Statement}}
\newcommand{\Formula}{\tsc{Formula}}
\newcommand{\GFormula}{\widetilde{\tsc{For}}\tsc{mula}}
\newcommand{\FrmFormula}{\tsc{Frm}\Formula}
\newcommand{\GFrmFormula}{\tsc{Frm}\GFormula}
\newcommand{\SatFormula}{\tsc{Sat}\Formula}
\newcommand{\GSatFormula}{\tsc{Sat}\GFormula}
\newcommand{\FrmSatFormula}{\tsc{FrmSat}\Formula}
\newcommand{\GFrmSatFormula}{\tsc{FrmSat}\GFormula}
\newcommand{\Greq}{\widetilde{\tsf{req}}\tsf{uired}}
\newcommand{\Ggranted}{\widetilde{\tsf{gra}}\tsf{nted}}
\newcommand{\worefs}{{\ \tsf{withoutRefs}\ }}

\newcommand{\gphi}{\phi \ \ast \ ?}

%
% math
\newenvironment{mathleftalign}
  { \begin{array}{l} }
  { \end{array} }
\newenvironment{mathdefinition}
  { \begin{array}{lcl} }
  { \end{array} }
\newenvironment{mathmatchwith}
  { \begin{array}{|lcl} }
  { \end{array} }
