...
%TODO: explain/justify this desicion

%TODO: are there any of these?
% \subsection{Implicit Global Aliasing Context}
%
% There are a few aliasing propositions that are assumed globally. These are
% \begin{itemize}
% \item $\forall o \in \O : \ \pnot \aliased\set{o, \cnull}$ i.e. no object variable can
% \end{itemize}
